...
public class TagsAdapter extends RecyclerView.Adapter<TagsAdapter.ViewHolder> {
    ...
    public TagsAdapter(Context context,List<String> mDatas) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view=inflater.inflate(R.layout.activity_tagsitem,parent,false);
        ViewHolder viewHolder=new ViewHolder(view);
        viewHolder.textView= (TextView) view.findViewById(R.id.myContent);
        return viewHolder;
    }
